    ...
    <div class="flex-1 overflow-y-auto p-4 md:p-8 space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
                ...
                <p class="text-[#4c669a] dark:text-[#a0aec0] mt-1">Generate detailed logs for official and adhoc
                    meetings.</p>
            </div>
            <div class="flex gap-2">
                <button
                    class="flex items-center gap-2 px-4 py-2 bg-white dark:bg-[#2d3748] border border-[#e7ebf3] dark:border-[#4a5568] rounded-lg text-sm font-medium text-[#0d121b] dark:text-white hover:bg-gray-50 dark:hover:bg-[#394557] transition-colors">
                    <span class="material-symbols-outlined text-[18px]">tune</span>
                    Customize
                </button>
                <button
                    class="flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg text-sm font-medium hover:bg-primary/90 transition-colors shadow-sm shadow-primary/30">
        ...
        <div
            class="bg-white dark:bg-[#1a202c] rounded-xl shadow-sm border border-[#e7ebf3] dark:border-[#2d3748] overflow-hidden">
            <!-- Tabs -->
            <div class="flex border-b border-[#e7ebf3] dark:border-[#2d3748]">
                <button
                    class="flex-1 px-6 py-3 text-sm font-medium text-primary border-b-2 border-primary bg-primary/5 dark:bg-primary/10 transition-colors">
                    Official Rooms
                </button>
                <button
                    class="flex-1 px-6 py-3 text-sm font-medium text-[#4c669a] dark:text-[#a0aec0] hover:text-[#0d121b] dark:hover:text-white transition-colors">
                    Adhoc Events
                </button>
            </div>
            <div class="p-5 grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
                ...
                <div class="md:col-span-4 flex flex-col gap-1.5">
                    <label
                        class="text-xs font-semibold text-[#4c669a] dark:text-[#a0aec0] uppercase tracking-wider">Select
                        Room</label>
                    <div class="relative">
                        <select
                            class="w-full h-10 pl-3 pr-10 text-sm bg-[#f6f6f8] dark:bg-[#2d3748] border-none rounded-lg focus:ring-2 focus:ring-primary text-[#0d121b] dark:text-white appearance-none cursor-pointer">
                            <option>Executive Boardroom A</option>
                            <option>Marketing Huddle Area</option>
                            <option>Main Hall - Townhall</option>
                        </select>
                        <span
                            class="material-symbols-outlined absolute right-3 top-2.5 text-[#4c669a] pointer-events-none text-[20px]">expand_more</span>
                    </div>
                </div>
                <!-- Date Range -->
                <div class="md:col-span-3 flex flex-col gap-1.5">
                    <label
                        class="text-xs font-semibold text-[#4c669a] dark:text-[#a0aec0] uppercase tracking-wider">Date
                        Range</label>
                    <div class="relative">
                        <input
                            class="w-full h-10 pl-9 pr-3 text-sm bg-[#f6f6f8] dark:bg-[#2d3748] border-none rounded-lg focus:ring-2 focus:ring-primary text-[#0d121b] dark:text-white cursor-pointer"
                            readonly="" type="text" value="Oct 24, 2023 - Oct 31, 2023" />
                        <span
                            class="material-symbols-outlined absolute left-2.5 top-2.5 text-[#4c669a] pointer-events-none text-[18px]">calendar_today</span>
                    </div>
                </div>
                <!-- Status Filter -->
                <div class="md:col-span-3 flex flex-col gap-1.5">
                    <label
                        class="text-xs font-semibold text-[#4c669a] dark:text-[#a0aec0] uppercase tracking-wider">Status</label>
                    <div class="relative">
                        <select
                            class="w-full h-10 pl-3 pr-10 text-sm bg-[#f6f6f8] dark:bg-[#2d3748] border-none rounded-lg focus:ring-2 focus:ring-primary text-[#0d121b] dark:text-white appearance-none cursor-pointer">
                        ...
                        <span
                            class="material-symbols-outlined absolute right-3 top-2.5 text-[#4c669a] pointer-events-none text-[20px]">filter_list</span>
                    </div>
                </div>
                <!-- Location Toggle -->
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div
                class="bg-white dark:bg-[#1a202c] p-4 rounded-xl shadow-sm border border-[#e7ebf3] dark:border-[#2d3748] flex items-center gap-4">
        ...
        <!-- Data Table Section -->
        <div
            class="bg-white dark:bg-[#1a202c] rounded-xl shadow-sm border border-[#e7ebf3] dark:border-[#2d3748] flex flex-col">
            <div class="flex items-center justify-between p-4 border-b border-[#e7ebf3] dark:border-[#2d3748]">
                ...
                <div class="flex gap-2">
                    <button
                        class="p-2 text-[#4c669a] hover:bg-[#f6f6f8] dark:hover:bg-[#2d3748] rounded-lg transition-colors">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm text-[#0d121b] dark:text-white">
                    <thead
                        class="bg-[#f8f9fc] dark:bg-[#2d3748] text-[#4c669a] dark:text-[#a0aec0] uppercase text-xs font-semibold">
                        <tr>
                    ...
                    <tbody class="divide-y divide-[#e7ebf3] dark:divide-[#2d3748]">
                        ...
                        <tr class="hover:bg-[#f8f9fc] dark:hover:bg-[#2d3748]/50 transition-colors group">
                            ...
                            <td class="px-6 py-4">
                                <span
                                    class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300 border border-green-200 dark:border-green-800">
                        ...
                        <tr class="hover:bg-[#f8f9fc] dark:hover:bg-[#2d3748]/50 transition-colors group">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="size-8 rounded-full bg-cover bg-center"
                                        data-alt="Profile picture of David Chen"
                            ...
                            <td class="px-6 py-4">
                                <span
                                    class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-300 border border-yellow-200 dark:border-yellow-800">
                        ...
                        <tr class="hover:bg-[#f8f9fc] dark:hover:bg-[#2d3748]/50 transition-colors group">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="size-8 rounded-full bg-cover bg-center"
                                        data-alt="Profile picture of James Wilson"
                            ...
                            <td class="px-6 py-4">
                                <span
                                    class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-300 border border-red-200 dark:border-red-800">
                        ...
                        <tr class="hover:bg-[#f8f9fc] dark:hover:bg-[#2d3748]/50 transition-colors group">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="size-8 rounded-full bg-cover bg-center"
                                        data-alt="Profile picture of Elena Rodriguez"
            ...
            <div class="flex items-center justify-between p-4 border-t border-[#e7ebf3] dark:border-[#2d3748]">
                <span class="text-sm text-[#4c669a] dark:text-[#a0aec0]">Showing <span
                        class="font-medium text-[#0d121b] dark:text-white">1-4</span> of <span
                        class="font-medium text-[#0d121b] dark:text-white">124</span> results</span>
                <div class="flex gap-2">
                    <button
                        class="flex items-center justify-center size-8 rounded-lg border border-[#e7ebf3] dark:border-[#4a5568] text-[#4c669a] dark:text-[#a0aec0] hover:bg-[#f6f6f8] dark:hover:bg-[#2d3748] disabled:opacity-50">
                        <span class="material-symbols-outlined text-[18px]">chevron_left</span>
                    </button>
                    <button
                        class="flex items-center justify-center size-8 rounded-lg bg-primary text-white text-sm font-medium">1</button>
                    <button
                        class="flex items-center justify-center size-8 rounded-lg border border-[#e7ebf3] dark:border-[#4a5568] text-[#4c669a] dark:text-[#a0aec0] hover:bg-[#f6f6f8] dark:hover:bg-[#2d3748] text-sm font-medium">2</button>
                    <button
                        class="flex items-center justify-center size-8 rounded-lg border border-[#e7ebf3] dark:border-[#4a5568] text-[#4c669a] dark:text-[#a0aec0] hover:bg-[#f6f6f8] dark:hover:bg-[#2d3748] text-sm font-medium">...</button>
                    <button
                        class="flex items-center justify-center size-8 rounded-lg border border-[#e7ebf3] dark:border-[#4a5568] text-[#4c669a] dark:text-[#a0aec0] hover:bg-[#f6f6f8] dark:hover:bg-[#2d3748]">
